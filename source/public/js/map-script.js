	...
	function initialize() {
		...
		//=======================================================================================
  		var mapOptions = {
    		...
    		center: new google.maps.LatLng(44.429450, 26.093992),
			panControl: true,
  			zoomControl: true,
  			mapTypeControl: true,
  			//scaleControl: false,
		...
		var marker1 = new MarkerWithLabel({
       		position: new google.maps.LatLng(44.429507, 26.094200),
       		draggable: false,
       		raiseOnDrag: false,
       		icon: ' ',
       		map: map, 
		...
		var marker2 = new MarkerWithLabel({
       		position: new google.maps.LatLng(44.580856, 26.076982),
       		draggable: false,
       		raiseOnDrag: false,
       		icon: ' ',
       		map: map, 
		...
		window.party = function() {
			map.setCenter(new google.maps.LatLng(44.580731, 26.076984));
			infowindow1.open(map,marker2);			
		}
		
		window.religious = function() {
			map.setCenter(new google.maps.LatLng(44.429450, 26.093992));
			infowindow.open(map, marker1);
		}
	}
